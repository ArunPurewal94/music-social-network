<template>
    <div id="edit-post" class="container max-w-4xl mx-auto pt-20 pb-20 px-6">
        ...
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full px-3">
                <CroppedImage label="Edited Post Image" :image="image" />
            </div>
        </div>
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full px-3">
        ...
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full px-3">
                <SubmitFormButton @click="updatePost" btnText="Edit Post" />
            </div>
        </div>
    </div>
</template>
...
import TextArea from "@/components/global/TextAreaComponent.vue";
