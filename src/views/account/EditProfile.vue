<template>
    <div id="edit-profile" class="container max-w-4xl mx-auto pt-20 pb-20 px-6">
        ...
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full px-3">
                <CroppedImage label="Profile Image" :image="image" />
            </div>
        </div>
        <div class="flex flex-wrap mt-4 mb-6">
            <div class="w-full px-3">
...
const updateUser = async () => {
    ...
    try {
        ...
        Swal.fire("Profile Updated", "Redirected to Profile", "success");
